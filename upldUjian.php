...
<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Upload Ujian!</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="" method="post" enctype = "multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="uploadUjianKelas" class="col-sm-2 control-label">Kelas</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="uploadUjianKelas" name="uploadUjianKelas" placeholder="Kelas">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" id="uploadUjiantSubmit" name="uploadUjiantSubmit">Submit</button>
              </div>
              <!-- /.box-footer -->
            </form>
  ...
  <div class="modal modal-files fade" id="modal-files">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Ujian Files&hellip;</h4>
                                        </div>
