...
$(document).ready(function(){
    $('.view_sett').click(function(){
        var nimna = $(this).attr("id");
        ...
        $.ajax({
            ...
            success:function(data){
                $('#detail_sett').html(data);
                $('#modal-sett').modal("show");
            }
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav">
                ...
                <?php
                if(isset($_POST['gantiPort'])){
                    $portNya = $_POST['gantiPort'];
                    $GLOBALS['portGlobe'] = $portNya;
                    // echo "http://192.168.1.54:".$portNya."/";
                }
                
                ?>
               
                <li><a href="http://192.168.1.50:7070/" >View Dosen</a></li>
                <!-- <li><a href="#" onclick="FileUjian();return false;">File Ujian</a></li> -->
          </ul>
        </div>
                    ...
                    if($statusMhs=="Asisten"){
                        ?>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="#" onclick="upldTgs();return false;">Tugas</a></li>
                                <li><a href="#" onclick="upldUjian();return false;">Ujian</a></li>
                            </ul>
                            </li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" onclick="lht_poin();return false;">Poin</a></li>
                                <li class="divider"></li>
                                <li><a href="#" onclick="lht_pretest();return false;">Pretest</a></li>
                                <li><a href="#" onclick="lht_laporan();return false;">Laporan</a></li>
                                <li><a href="#" onclick="lht_tugas();return false;">Tugas</a></li>
                            </ul>
                            </li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                            <li><a href="#" onclick="input_poi();return false;">Poin</a></li>
                            <li class="divider"></li>
                            <li><a href="#" onclick="input_pre();return false;">Pretest</a></li>
                            <li><a href="#" onclick="input_lap();return false;">Laporan</a></li>
                            ...
                            <ul class="dropdown-menu" role="menu">
                            <li><a href="#" onclick=";return false;">Absensi Harian</a></li>
                            <li class="divider"></li>
                            <li><a href="#" onclick=";return false;">Rekap Absensi</a></li>
                            </ul>
                            </li> -->

                        <!-- <li><a href="rkp.php">Rekap</a></li> -->
                        </ul>
                        ...
                        <div class="box box-info">
                            ...
                            <form action="" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <a href="#" data-toggle="modal" data-target="#modal-lupa" class="pull-right">Lupa Password?</a>
                                    </div>
                                    </div>
                                </div>
                                </div>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="#" id="<?php echo $_SESSION['use'];?>" class="btn btn-default btn-flat view_sett">Pengaturan</a>
                  </div>
